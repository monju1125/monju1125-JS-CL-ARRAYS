...
public class SeleniumTest {
    ...
    private File findHtmlFile() {
        String[] possibleHtmlPaths = {
            "src/main/Arrays.html",
            "Arrays.html",
            "src/test/resources/Arrays.html",
            "test-resources/Arrays.html",
            "src/main/resources/Arrays.html"
        };
        ...
        throw new RuntimeException("Could not find Arrays.html in any expected location: " + 
